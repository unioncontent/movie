					               ...
					               <font style="font-weight: bold; color: black;">                     
                            		...
                            		<div class="table-responsive">
                                      <table class="table table-bordered table-sm">
                                        ...
                                        <tbody>
                                        <c:if test="${!empty mediaDataList}">
                                          <c:forEach items="${mediaDataList}" var = "mediaVO" varStatus="index">
                                          <tr>
                                          ...
                                          <c:if test="${!empty mediaMatchDataList}">
                                          <c:forEach items="${mediaMatchDataList}" var = "mediaVO" varStatus="index">
                                          <tr>
                                            <th scope="row">${index.count}</th>
                                            <td>${mediaVO.media_name}</td>
                                            <td>${mediaVO.reporter_name}</td>
