                            		...
                            		<div class="table-responsive">
                                      ...
                                      <c:if test="${!empty mediaList}">
                                        ...
                                        <tbody>
                                          ...
                                          <c:forEach items="${mediaList}" var = "mediaVO" varStatus="index">
                                          <tr>
                                          ...
                                          <tr>
                                            ...
                                            <td>
	                                            <div class="title-nowrap">
	                                            	<a class = 'title_score' href="${score.url}" target="_blank">${score.portal_title}</a>
	                                            </div>
                                            </td>
                                            <td>${score.keyword}</td>
                                            <td>${score.score}</td>
                                        ...
                                        <tbody>
                                          <c:forEach items="${classiList2}" var = "extractVO" varStatus="index">
                                          <tr>
                                            <th scope="row">${index.count}</th>
                                            <td>${extractVO.domain}</td>
		                                    <td>${extractVO.domainType}</td>
