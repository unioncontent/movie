                              ...
                              <div class="col-md-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <!-- <button class="btn btn-info f-right alert-confirm" onclick = "location.href='http://overware.iptime.org:8080/marketing/b_channel'"><i class="icofont icofont-ui-note"></i>목록으로</button> -->
                                            ...
                                            <td colspan="7">
                                              <%-- <ul class="pagination float-right">
                                                <c:if test="${pageMaker.prev}">
                                              		<li class="page-item">
                                                		  <a class="page-link" href="b_list${pageMaker.makeSearch(pageMaker.startPage - 1) }" aria-label="Previous">&laquo;
                                          		  ...
                                          		  <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="idx">
                                              		<li class= "${pageMaker.cri.page == idx? 'active':''} page-item">
                                                		  <a class="page-link" href="b_list${pageMaker.makeSearch(idx)}">${idx}</a>
                                              		</li>
                                          		  </c:forEach>
                                          		  <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                                              		<li class="page-item">
                                              		  <a class="page-link" href="b_list${pageMaker.makeSearch(pageMaker.endPage +1) }" aria-label="Next">&raquo;
                                                		<span aria-hidden="true"></span>
...
$(document).ready(function(){
	...
	$(".list-button").on("click", function(event){
		...
		self.location = "b_listall?url=" + url + "&createstartDate=" + createstartDate + "&createendDate=" + createendDate + "&content=" + content;
