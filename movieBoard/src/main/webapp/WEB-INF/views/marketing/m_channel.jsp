                    ...
                    <div class="col-md-12">
                        <div class="card">
                          <div class="card-header">
                          	<h5><font style="font-weight: bold; color: black;"><i class="icofont icofont-imac"></i>&nbsp;&nbsp;MEGABOX 모니터링</font></h5>
                                            ...
                                            <td colspan="9">
                                               <ul class="pagination float-right">
	        					                   <c:if test="${pageMaker.prev}">
		        					                   <li class="page-item">
			        					                   <a class="page-link" href="m_channel${pageMaker.makeSearch(pageMaker.startPage - 1) }" aria-label="Previous">&laquo;
        					                   ...
        					                   <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="idx">
	        					                   <li class= "${pageMaker.cri.page == idx? 'active':''} page-item">
	        					                   	<a class="page-link" href="m_channel${pageMaker.makeSearch(idx)}">${idx}</a>
	        					                   </li>
        					                   </c:forEach>
        					                   <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
	        					                   <li class="page-item">
		        					                   <a class="page-link" href="m_channel${pageMaker.makeSearch(pageMaker.endPage +1) }" aria-label="Next">&raquo;
			        					               <span aria-hidden="true"></span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(".twin-button").on("click", function(event){
			...
			self.location = "m_graph?url=" + url + "&url2=" + url2;
