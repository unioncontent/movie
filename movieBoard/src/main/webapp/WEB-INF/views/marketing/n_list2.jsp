                                    ...
                                    <div class="table-responsive">
                                      <table class="table table-bordered table-sm">
                                        ...
                                        <c:forEach var="list" items="${list}" varStatus="index">
                                          <tr class = "trList">
                                            <th scope="row">${totalCount - index.count + 1}</th>
                                            <td>
                                            ...
                                            <td>
                                            	...
                                            	<input type="hidden" value="${list.portal_title}" name="content" id="content">
                                            </td>
                                            <td>
                                            ...
                                            <a href='${list.url}' target="_blank">${list.portal_title}</a>
                                            </div>
                                            </td>
                                            <td>
                                            ...
                                            <td colspan="7">
                                              <%-- <ul class="pagination float-right">
                                                <c:if test="${pageMaker.prev}">
                                              		<li class="page-item">
                                                		  <a class="page-link" href="n_list2${pageMaker.makeSearch(pageMaker.startPage - 1) }" aria-label="Previous">&laquo;
                                          		  ...
                                          		  <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="idx">
                                              		<li class= "${pageMaker.cri.page == idx? 'active':''} page-item">
                                                		  <a class="page-link" href="n_list2${pageMaker.makeSearch(idx)}">${idx}</a>
                                              		</li>
                                          		  </c:forEach>
                                          		  <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                                              		<li class="page-item">
                                              		  <a class="page-link" href="n_list2${pageMaker.makeSearch(pageMaker.endPage +1) }" aria-label="Next">&raquo;
                                                		<span aria-hidden="true"></span>
...
$(document).ready(function(){
	...
	$(".list-button").on("click", function(event){
		...
		self.location = "n_listall2?url=" + url + "&content=" + content + "&createstartDate=" + createstartDate + "&createendDate=" + createendDate;
