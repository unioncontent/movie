                  ...
                  <div class="page-body">
                    ...
                    <div class="col-md-12">
                       ...
                       <%-- <div class="row">
		                      ...
		                      <select class="form-control form-control-inverse" style="width: 700px; margin-left: 15px; margin-right: 15px;" id="e1">
                              	  <c:forEach items="${nVallList}" var="nV">
								  	<option value="${nV.url}">${nV.portal_title}</option>
								  </c:forEach>
            				  </select>
            				  <label style="margin-left: 15px; margin-right: 15px;">제목</label>
            				  <select class="form-control form-control-inverse" style="width: 700px; margin-left: 15px; margin-right: 15px;" id="e2">
	                              <c:forEach items="${nVallList}" var="nV">
								  	<option value="${nV.url}">${nV.portal_title}</option>
								  </c:forEach>
            				  </select>
                              ...
                              <div class="col-md-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <button class="btn btn-list f-right p-r-5 p-l-5 m-l-3 m-b-5 m-t-5"  style="float: left; margin-top: 10px;" type="button" onclick="show()"><i class="icofont icofont-ui-note"></i>최근목록</button>
                                    <c:if test="${user.user_name == 'union'}">
                                      ...
                                      <table class="table table-bordered table-sm">
                                        ...
                                        <tbody>
                                          ...
                                          <tr class = "trList">
                                            ...
                                            <td>
                                            <fmt:formatNumber value="${nV.total}" pattern="#,##0" />건
                                            </td>
                                            <td>
                                            ...
                                            <td colspan="9">
                                               <ul class="pagination float-right">
	        					                   <c:if test="${pageMaker.prev}">
		        					                   <li class="page-item">
			        					                   <a class="page-link" href="n_channel2${pageMaker.makeSearch(pageMaker.startPage - 1) }" aria-label="Previous">&laquo;
        					                   ...
        					                   <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="idx">
	        					                   <li class= "${pageMaker.cri.page == idx? 'active':''} page-item">
	        					                   	<a class="page-link" href="n_channel2${pageMaker.makeSearch(idx)}">${idx}</a>
	        					                   </li>
        					                   </c:forEach>
        					                   <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
	        					                   <li class="page-item">
		        					                   <a class="page-link" href="n_channel2${pageMaker.makeSearch(pageMaker.endPage +1) }" aria-label="Next">&raquo;
			        					               <span aria-hidden="true"></span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(".twin-button").on("click", function(event){
			...
			self.location = "n_graph2?url=" + url + "&url2=" + url2;
