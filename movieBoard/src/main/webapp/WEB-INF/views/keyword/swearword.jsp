                    ...
                    <div class="card">
                      <div class="card-header">
                        <div class="col-md-1 p-r-0 f-right">
                          <a href="swearwordCreate" class="btn btn-primary float-right">등록</a>
                        </div>
                      </div>
                      <div class="card-block table-border-style">
                        <div class="table-responsive">
                          <table class="table table-bordered table-sm">
                            ...
                            <tbody>
                              <c:forEach items="${swearwordList}" var="swearword" varStatus="index">
                              <tr>
                                <th scope="row">${index.count}</th>
                                <td><fmt:formatDate value="${swearword.createDate}" type="DATE" pattern="yyyy/MM/dd HH:mm:ss" /></td>
                                <td>${swearword.swearword}</td>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(".tabledit-delete-button").on("click", function(event){
			...
			var swearword = td.childNodes[0];
			console.log(swearword.data);
