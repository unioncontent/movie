                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="radios">
                                        ...
                                        <input type="radio" id="radio2" name="radios1">
                                    ...
                                    <td>
                                      <button class="btn btn-info btn-sm image" data-toggle="tooltip" data-placement="top" data-original-title="이미지보기"><i class="icofont icofont-ui-image" style="margin-right:0"></i></button>
                                    </td>
                                    <td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="radios">
                                        ...
                                        <label for="radio5">좋은글</label>
                                        <input type="radio" id="radio6" name="radios2" checked>
                                        <label for="radio6">나쁜글</label>
                                        <input type="radio" id="radio7" name="radios2">
                                        <label for="radio7">관심글</label>
                                        <input type="radio" id="radio8" name="radios2">
                                        <label for="radio8">기타글</label>
                                      </div>
                                    </td>
                                    <td>
                                      <button class="btn btn-info btn-sm image" data-toggle="tooltip" data-placement="top" data-original-title="이미지보기"><i class="icofont icofont-ui-image" style="margin-right:0"></i></button>
