									...
									<div class="page-header">
										...
										<div class="page-header-breadcrumb">
											<ul class="breadcrumb-title">
												...
												<li class="breadcrumb-item"><a href="#!">네이버TALK</a></li>
											</ul>
										</div>
									</div>
									<div class="page-body">
										...
										<div class="card">
											<div class="card-header">
												<select id="selectSearchType" name="select" class="col-sm-1 form-control form-control-inverse m-r-5 m-t-5 m-b-5 f-left search-select" style="height:40px;">
													<option id="t" value="t">글쓴이</option>
													<option id="c" value="c">내용</option>
												</select>
											...
											<div class="card-block table-border-style">
												<div class="table-responsive">
				                                    ...
				                                    <c:if test="${!empty naverTalkList}">
														...
														<tbody>
															<c:forEach items="${naverTalkList}" var="naverTalkList" varStatus="index">
																<tr>
																	...
																	<td>
																		<a href="${naverTalkList.url}" target="_blank">
																			<img alt="naver" src="../assets/images/siren-2859791__340.png" style="width: 20px; height: 20px;">
																		</a>
																	</td>
																</tr>
															</c:forEach>
																...
																<td colspan="6">
																	<ul class="pagination float-right">
							        					                   <c:if test="${pageMaker.prev}">
								        					                   <li class="page-item">
									        					                   <a class="page-link" href="naverTalk${pageMaker.makeSearch(pageMaker.startPage - 1) }" aria-label="Previous">&laquo;
						        					                   ...
						        					                   <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="idx">
							        					                   <li class= "${pageMaker.cri.page == idx? 'active':''} page-item">
							        					                   	<a class="page-link" href="naverTalk${pageMaker.makeSearch(idx)}">${idx}</a>
							        					                   </li>
						        					                   </c:forEach>
						        					                   <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							        					                   <li class="page-item">
								        					                   <a class="page-link" href="naverTalk${pageMaker.makeSearch(pageMaker.endPage +1) }" aria-label="Next">&raquo;
									        					               <span aria-hidden="true"></span>
