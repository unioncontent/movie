                            ...
                            <div class="col-lg-12">
                              ...
                              <div class="report" id="reportdiv" style="margin: 0px auto;">
                              		<!-- 복사 시작 -->
									    ...
									    <tr>
									    <td align="left">
									    <img src="http://180.210.5.160:8080/classification/show?name=/union_logo/union_logo.png" alt="Theme-Logo" style="margin-top: 3px;float: left; width: 150; height: 27;">
									    ...
									    <a style="color: rgb(153, 153, 153); letter-spacing: -1px; font-family: gulim,verdana; font-size: 13px; text-decoration: none;" href="http://showbox.email" target="_blank" rel="noopener noreferrer">Email</a>
									    </td>
									    </tr>
									    </tbody>
									    </table>
									            	...
									            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
									                  ...
									                  <table width="556" border="0" cellspacing="0" cellpadding="0">
									                        ...
									                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
									                              ...
									                              <tr><td height="1" bgcolor="#e4e4e4"></td><td bgcolor="#e4e4e4"></td><td height="1" bgcolor="#e4e4e4"></td></tr><tr><td align="center" style="color: rgb(57, 130, 199); letter-spacing: -1px; font-family: Gulim,verdana; font-size: 12px; font-weight: bold; border-right-color: rgb(228, 228, 228); border-right-width: 1px; border-right-style: solid; text-align: center;" bgcolor="#eff7ff">보고기간</td><td> </td><td align="left" style="padding: 10px 10px 10px 0px; color: rgb(102, 102, 102); line-height: 18px; letter-spacing: -1px; font-family: Gulim,verdana; font-size: 12px;">&nbsp;${startDate} ~ ${endDate}</td></tr>
									                              <tr><td height="1" bgcolor="#e4e4e4"></td><td bgcolor="#e4e4e4"></td><td height="1" bgcolor="#e4e4e4"></td></tr><tr><td align="center" style="color: rgb(57, 130, 199); letter-spacing: -1px; font-family: Gulim,verdana; font-size: 12px; font-weight: bold; border-right-color: rgb(228, 228, 228); border-right-width: 1px; border-right-style: solid; text-align: center;" bgcolor="#eff7ff">보고날짜</td><td> </td><td align="left" style="padding: 10px 10px 10px 0px; color: rgb(102, 102, 102); line-height: 18px; font-family: Gulim,verdana; font-size: 12px;">&nbsp;${today}</td></tr></tbody></table></td></tr><tr><td align="center">
												                        ...
												                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
											                              <tbody>
											                              <c:forEach items="${headlineList}" var = "headlineList" varStatus="index">
											                              <tr>
											                              <td align="left" style="color: rgb(102, 102, 102);  font-family: Gulim,verdana; font-size: 12px;">
											                              <div style="width: 100px; overflow: hidden; text-overflow: ellipsis;">
											                              	<img align="absmiddle" width="3" height="3" src="http://file1.jobkorea.co.kr/Mailing/report/bullet.gif"> ${headlineList.writeDate}
											                              	</div>
											                              	</td>
												                        ...
												                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
											                              ...
											                              <td align="left" style="color: rgb(102, 102, 102);  font-family: Gulim,verdana; font-size: 12px;">
											                              <div style="width: 150px; overflow: hidden; text-overflow: ellipsis;">
											                              	<img align="absmiddle" width="3" height="3" src="http://file1.jobkorea.co.kr/Mailing/report/bullet.gif"> ${scoreList.writeDate}
											                              	</div>
											                              	</td>
											                              <td align="left" style="color: rgb(102, 102, 102); line-height: 18px; letter-spacing: -1px; font-family: Gulim,verdana; font-size: 12px;">
											                              <div style="width: 400px; overflow: hidden; text-overflow: ellipsis;">
												                          	${scoreList.portal_title}
												                          	</div>
												                          </td>
												                           </tr>
												                           </c:forEach>
									                                    ...
									                                    <td> </td><td align="left" style="color: rgb(102, 102, 102); letter-spacing: -1px; font-family: Gulim,verdana; font-size: 11px; font-weight: bold;"><img align="absmiddle" width="3" height="3" src="http://file1.jobkorea.co.kr/Mailing/report/bullet.gif"> SNS 현황</td></tr>
