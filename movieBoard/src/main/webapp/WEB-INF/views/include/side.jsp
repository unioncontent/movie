     ...
     <%-- <c:if test="${user.user_name == '쇼박스'}"> 
      ...
      <li class="pcoded-hasmenu media">
        ...
        <ul class="pcoded-submenu">
          ...
          <li class=" ">
            <a href="../media/media_match" data-i18n="nav.advance-components.draggable">
              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
              <span class="pcoded-mtext">언론사 매칭 리스트</span>
              <span class="pcoded-mcaret"></span>
            </a>
          </li>
          <c:if test="${user.user_name == 'union'}">
      ...
      <li class="extract">
        <a href="../extract/extract?perPageNum=30" data-i18n="nav.advance-components.main">
      ...
      <li class="classification">
        <a href="../classification/classification?perPageNum=30" data-i18n="nav.advance-components.main">
        ...
        <li class="listAll">
          <a href="../listAll/listAll?perPageNum=30" data-i18n="nav.advance-components.main">
