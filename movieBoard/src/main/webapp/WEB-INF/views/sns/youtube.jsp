                  ...
                  <div class="page-header">
                    ...
                    <div class="page-header-breadcrumb">
                      <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">유튜브관리</a></li>
                      </ul>
                    </div>
                  </div>
                  <!-- Page-body start -->
                              ...
                              <tbody>
                                <c:forEach items="${youtubeList}" var="snsVO" varStatus="index">
                                  <tr>
                                    ...
                                    <td>${snsVO.keyword}</td>
                                    <td><div class="content-nowrap"><a href="${snsVO.url}" target="_blank">${snsVO.sns_title}</a></div></td>
                                    <td>${snsVO.sns_writer}</td>
                                    <td>${snsVO.like_cnt}</td>
                                    <td>${snsVO.view_cnt}</td>
                                ...
                                <tr>
                                  <td colspan="10">
                                    <ul class="pagination float-right">
                                        ...
                                        <li class="page-item">
                                          <a class="page-link" href="youtube${pageMaker.makeSearch(pageMaker.startPage - 1) }" aria-label="Previous">&laquo;
                                      ...
                                      <c:forEach begin="${pageMaker.startPage }"
                        								...
                        								<li class="${pageMaker.cri.page == idx? 'active':''} page-item">
                        									<a class="page-link" href="youtube${pageMaker.makeSearch(idx)}">${idx}</a>
                        								</li>
                      								</c:forEach>

                      								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                                        <li class="page-item">
                                          <a class="page-link" href="youtube${pageMaker.makeSearch(pageMaker.endPage +1) }" aria-label="Next">&raquo;
                                            <span aria-hidden="true"></span>
...
searchList();
	...
	$.ajax({
		  ...
		  url : "graph",
		  dataType : "json",
	 	  data : {success : 'success', portal_name : "youtube", company : company, selectKey : selectKey},
