...
UnitTest.test('LanguageGetTest', function () {
    var check = function (doc, id, lang) {
        ...
        RawAssertions.assertEq('check lang(). Expected: ' + lang.getOr('none') + ', actual: ' + itemLang.getOr('none'), true, lang.equals(itemLang));
    };
...
//# sourceMappingURL=LanguageGetTest.js.map