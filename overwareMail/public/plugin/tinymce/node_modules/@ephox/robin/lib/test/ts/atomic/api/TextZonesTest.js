...
UnitTest.test('TextZonesTest', function () {
    ...
    Logger.sync('Checking the (single) zone of an isolated inline tag', function () {
        var item = doc1.find(doc1.get(), 'isolated').getOrDie();
        var actual = TextZones.single(doc1, item, 'en', ZoneViewports.anything());
        RawAssertions.assertEq('Zone assertion', [{
                lang: 'en',
                elements: [
                    'en-i'
                ],
    ...
    Logger.sync('Checking the (single) zone of an isolated text node', function () {
...
//# sourceMappingURL=TextZonesTest.js.map