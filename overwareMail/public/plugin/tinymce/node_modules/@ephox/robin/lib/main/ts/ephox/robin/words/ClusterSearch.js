...
var flatten = function (universe, item) {
    return universe.property().isText(item) ? [WordDecision.detail(universe, item)] : Arr.map(universe.down().predicate(item, universe.property().isText), function (e) { return WordDecision.detail(universe, e); });
};
export default {
    creepLeft: creepLeft,
...
//# sourceMappingURL=ClusterSearch.js.map