...
UnitTest.test('DomClumpsTest', function () {
    ...
    var checkFractures = function (expected, start, soffset, finish, foffset) {
    ...
    checkFractures('<p>This is the s<strong>econd line.</strong></p>' +
        ...
        '<br>', [0, 0], 'This is the s'.length, [6], 'someth'.length);
    container.dom().innerHTML =
    ...
    checkFractures('<ol><li>apples</li><li>oranges</li>  </ol><p>And bre<strong>aking it:</strong></p><ol><li><strong>here</strong></li></ol><strong>and more<br>and mo</strong>re<br>and m<b>or</b>e<br>', [1, 0], 7, [5], 6);
    container.dom().innerHTML =
    ...
    checkFractures('Text n<span style="font-weight: bold;">ode <br> Anot<strong>her text node <br></strong></span>' +
        '<h3><span style="font-weight: bold;"><strong>Thi</strong>s is the heading line.</span></h3>', [1, 2], 5, [2, 0, 0], 3);
    container.dom().innerHTML =
    ...
    checkFractures('Text n<strong>ode <br> Another text node <br></strong><p><strong>This is the first line of what I am typing</strong></p>' +
        '<p><strong>This is th</strong>e second line.</p>', [0], 'Text n'.length, [5, 0], 'This is th'.length);
    container.dom().innerHTML = '<p>This is <b>bold text</b> and <i>italic text</i> here.</p>';
    // Highlighting from This| -> an|d
    checkFracture('<p>This<strong> is <b>bold text</b> an</strong>d <i>italic text</i> here.</p>', [0, 0], 'This'.length, [0, 2], ' an'.length);
    container.dom().innerHTML = '<p>This is <b>bold text</b> and <i>italic text</i> here.</p>';
    ...
    container.dom().innerHTML = '<p>This is <b>bold text</b> and <i>italic text</i> here.</p>';
    checkFracture('<p>T<strong>his is <b>bold</b></strong><b> text</b> and <i>italic text</i> here.</p>', [0, 0], 'T'.length, [0, 1, 0], 'bold'.length);
    container.dom().innerHTML = '<p>This is <b>bold text</b> and <i>italic text</i> here.</p>';
    ...
    container.dom().innerHTML = '<p>This is <b>bold text</b> and <i>italic text</i> here.</p>';
    checkFracture('<p>This is <b>b</b><strong><b>old text</b> and <i>italic text</i> he</strong>re.</p>', [0, 1, 0], 'b'.length, [0, 4], ' he'.length);
    container.dom().innerHTML = '<p>This is <b>bold text</b> and <i>italic text</i> here.</p>';
    checkFracture('<p>This is <b>b<strong>o</strong>ld text</b> and <i>italic text</i> here.</p>', [0, 1, 0], 'b'.length, [0, 1, 0], 'bo'.length);
    container.dom().innerHTML = '<p>This is <b>bold text</b> and <i>italic text</i> here.</p>';
    ...
    '<p>This is <b></b><strong><b>bold text</b> a</strong>nd <i>italic text</i> here.</p>', [0, 1, 0], ''.length, [0, 2], ' a'.length);
    container.dom().innerHTML = '<p>This is <b>bold text</b> and <i>italic text</i> here.</p>';
    checkFracture('<p>This is <b><strong>bold text</strong></b> and <i>italic text</i> here.</p>', [0, 1, 0], ''.length, [0, 1, 0], 'bold text'.length);
    container.dom().innerHTML = '<p>This <span>new <u>words</u></span> is <b>bold text</b> and <i>italic text</i> here.</p>';
    checkFracture('<p>This <span>new <u>words</u></span><strong> is <b>bo</b></strong><b>ld text</b> and <i>italic text</i> here.</p>', [0, 1], 2, [0, 3, 0], 'bo'.length);
    container.dom().innerHTML =
    ...
    checkFractures('<p>This is <b>the</b><strong><b> word</b> that I can understand, even if <i>it</i> is not the same as before.</strong></p>' +
        '<p><strong>And another <u>paragraph</u></strong></p>' +
        '<p><strong>Plus one more.</strong></p>' +
        '<p><strong>Last</strong> one, I promise</p>', [0, 1, 0], 'the'.length, [3, 0], 'Last'.length);
    container.dom().innerHTML =
    ...
    checkFractures('<p>This is <span>completely <i>different <b>f</b></i><strong><i><b>rom</b> </i>what you would<span>_expect_</span></strong></span></p>' +
        '<p><strong>And more <u>of this is <span>h</span></u></strong><u><span>ere</span> again</u>.</p>', [0, 1, 1, 1, 0], 't'.length, [1, 1, 1, 0], 'h'.length);
    container.dom().innerHTML = '<table><tbody><tr><td>One</td>\n\n\n \n<td>Two</td></tr>\n</tbody></table>';
    checkFractures('<table><tbody>' +
        '<tr>' +
    ...
    checkFractures('<table><caption><strong>Heading</strong></caption><tbody>\n' +
        '<tr>\n' +
        '<td><strong>One</strong></td>' +
        '\n\n\n \n' +
        '<td><strong>Two</strong></td>' +
    ...
    container.dom().innerHTML = '<ol><li>One</li><li>Two</li><li>Three</li></ol>';
    checkFractures('<ol><li><strong>One</strong></li><li><strong>Two</strong></li><li><strong>Three</strong></li></ol>', [0, 0], 0, [0, 2], 0);
    Remove.remove(container);
});
//# sourceMappingURL=DomClumpsTest.js.map