...
export default (function () {
    ...
    var tieredMenu = TieredMenu.tieredMenu.sketch({
        dom: {
            tag: 'div',
        ...
        data: TieredMenu.tieredMenu.tieredData('styles', {
    ...
    var menu = HtmlDisplay.section(gui, 'This menu is a card menu', tieredMenu);
});
//# sourceMappingURL=CardMenuDemo.js.map