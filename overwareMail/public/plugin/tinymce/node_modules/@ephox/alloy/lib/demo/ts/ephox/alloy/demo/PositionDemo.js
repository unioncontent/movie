...
export default (function () {
    ...
    gui.add(sink);
    var popup = GuiFactory.build(Container.sketch({
        components: [
            Container.sketch({
                dom: {
                    styles: {
    ...
    var section1 = HtmlDisplay.section(gui, 'Position anchoring to button', Button.sketch({
        dom: {
            tag: 'button',
    ...
    var section2 = HtmlDisplay.section(gui, 'Position anchoring to menu', Container.sketch({
        dom: {
            tag: 'ol',
            styles: {
    ...
    var section3 = HtmlDisplay.section(gui, 'Position anchoring to text selection', Container.sketch({
        dom: {
            tag: 'div'
        },
        components: [
            ...
            Button.sketch({
                ...
                action: function (button) {
                    ...
                    Positioning.position(sink, {
                        anchor: 'selection',
                        root: button.getSystem().getByUid('text-editor').getOrDie('Could not find text editor').element()
                    }, popup);
                }
            })
        ]
    ...
    var section4 = HtmlDisplay.section(gui, 'Position anchoring to text selection [iframe]', Container.sketch({
        components: [
            GuiFactory.external({
                element: frame,
                uid: 'frame-editor'
...
//# sourceMappingURL=PositionDemo.js.map