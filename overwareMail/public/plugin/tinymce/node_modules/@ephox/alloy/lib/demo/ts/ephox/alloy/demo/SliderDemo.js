...
export default (function () {
    ...
    var slider1 = HtmlDisplay.section(gui, 'This is a basic slider from [20, 100] with snapping to grid at 10', Slider.sketch({
        dom: {
            tag: 'div'
        },
        min: 20,
    ...
    var slider2 = HtmlDisplay.section(gui, 'This is a basic slider with two snapping regions [35] and [75]. The minimum value is 0', Slider.sketch({
    ...
    var hueSlider = HtmlDisplay.section(gui, 'This is a basic color slider with a sliding thumb and edges', Slider.sketch({
        dom: {
            tag: 'div',
            styles: {
