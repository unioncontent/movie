...
UnitTest.asynctest('CouplingTest', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        ...
        return [
            StepUtils.sAssertFailContains('Testing getCoupled with invalid name: fake', 'No information found for coupled component: fake', function () {
                Coupling.getCoupled(component, 'fake');
            }),
            Logger.t('Testing getCoupled with valid name: secondary-1', Step.sync(function () {
                ...
                Assertions.assertEq('secondary1 is not recreated. Should still have attribute: data-test', 'marked', Attr.get(Coupling.getCoupled(component, 'secondary-1').element(), 'data-test'));
            })),
...
//# sourceMappingURL=CouplingTest.js.map