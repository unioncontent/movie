...
UnitTest.asynctest('SplitDropdown List', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        var c = GuiFactory.build(SplitDropdown.sketch({
            dom: {
                tag: 'span',
        ...
        return [
            Assertions.sAssertStructure('Check basic initial structure', ApproxStructure.build(function (s, str, arr) {
...
//# sourceMappingURL=SplitDropdownTest.js.map