    ...
    GuiSetup.setup(function (store, doc, body) {
        ...
        var testIsSelected = function (label) {
            return Step.sync(function () {
                Assertions.assertStructure('Asserting structure shows selected\n' + label, ApproxStructure.build(function (s, str, arr) {
        ...
        var testNotSelected = function (label) {
            return Step.sync(function () {
                Assertions.assertStructure('Asserting structure shows not selected\n' + label, ApproxStructure.build(function (s, str, arr) {
                    return s.element('div', {
                        classes: [
        ...
        var assertIsSelected = function (label, expected) {
            return Logger.t('Asserting isSelected()\n' + label, Step.sync(function () {
...
//# sourceMappingURL=TogglingTest.js.map