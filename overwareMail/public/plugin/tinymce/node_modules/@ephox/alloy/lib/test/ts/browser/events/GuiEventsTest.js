...
UnitTest.asynctest('GuiEventsTest', function () {
    ...
    var page = DomRender.renderToDom(DomDefinition.nu({
        tag: 'div',
    ...
    var sTestWindowScroll = GeneralSteps.sequence([
        ...
        Waiter.sTryUntil('Waiting for window scroll event to broadcast', store.sAssertEq('Checking scroll should have fired', [{ broadcastEventName: 'alloy.system.scroll' }]), 100, 1000),
        Step.sync(function () {
...
//# sourceMappingURL=GuiEventsTest.js.map