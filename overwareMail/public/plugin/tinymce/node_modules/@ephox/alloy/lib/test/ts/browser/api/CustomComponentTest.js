    ...
    GuiSetup.setup(function (store, doc, body) {
        var behaviourA = Behaviour.create({
            ...
            active: {
                ...
                events: Fun.constant(AlloyEvents.derive([
        ...
        return [
            Assertions.sAssertStructure('Checking initial DOM modification', ApproxStructure.build(function (s, str, arr) {
...
//# sourceMappingURL=CustomComponentTest.js.map