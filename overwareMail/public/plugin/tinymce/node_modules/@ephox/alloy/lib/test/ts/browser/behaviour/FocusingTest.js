...
UnitTest.asynctest('FocusingTest', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        ...
        return [
            Assertions.sAssertStructure('Checking tabindex is -1', ApproxStructure.build(function (s, str, arr) {
            ...
            Step.control(FocusTools.sIsOnSelector('Should not start with focus', doc, '.focusable'), 
...
//# sourceMappingURL=FocusingTest.js.map