...
export default [
    ...
    FieldSchema.strictOf('routes', ValueSchema.setOf(Result.value, ValueSchema.setOf(Result.value, ValueSchema.objOfOnly([
...
//# sourceMappingURL=TransitionSchema.js.map