...
UnitTest.asynctest('DropdownMenuTest', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        ...
        var sTestMenus = function (label, stored, focused, active, background, others) {
            var sCheckBackground = GeneralSteps.sequence(Arr.bind(background, function (bg) {
                return [
                    UiFinder.sExists(gui.element(), bg.selector),
                    UiFinder.sNotExists(gui.element(), bg.selector + '.selected-menu')
                ];
            }));
            var sCheckActive = GeneralSteps.sequence(Arr.map(active, function (o) {
                return UiFinder.sExists(gui.element(), o.selector + '.selected-menu');
            }));
            var sCheckOthers = GeneralSteps.sequence(Arr.map(others, function (o) {
        ...
        return [
            ...
            sTestMenus('Initially', [], focusables.button, [], [], [
            ...
            sTestMenus('After open', [], focusables.packages, [focusables.toolsMenu], [], [
                focusables.packagesMenu,
                focusables.sortbyMenu,
                focusables.stringsMenu,
                focusables.numbersMenu
            ...
            Keyboard.sKeydown(doc, Keys.enter(), {}),
            sTestMenus('After expand packages menu', [], focusables.sortby, [focusables.packagesMenu], [focusables.toolsMenu], [
                focusables.sortbyMenu,
                focusables.stringsMenu,
                focusables.numbersMenu
            ]),
            ...
            sTestMenus('After collapse packages menu', [], focusables.packages, [focusables.toolsMenu], [], [
                focusables.packagesMenu,
                focusables.sortbyMenu,
                focusables.stringsMenu,
                focusables.numbersMenu
            ...
            sTestMenus('After expanding packages menu with right arrow', [], focusables.sortby, [focusables.packagesMenu], [focusables.toolsMenu], [
                focusables.sortbyMenu,
                focusables.stringsMenu,
                focusables.numbersMenu
            ]),
            ...
            sTestMenus('After expanding sortby menu with space arrow', [], focusables.strings, [focusables.sortbyMenu], [focusables.toolsMenu, focusables.packagesMenu], [
                focusables.stringsMenu,
                focusables.numbersMenu
            ]),
            // Pressing down should focus on numbers
            Keyboard.sKeydown(doc, Keys.down(), {}),
            sTestMenus('After pressing down in sortby menu', [], focusables.numbers, [focusables.sortbyMenu], [focusables.toolsMenu, focusables.packagesMenu], [
                focusables.stringsMenu,
                focusables.numbersMenu
            ]),
            // Pressing escape should focus sortby
            Keyboard.sKeydown(doc, Keys.escape(), {}),
            sTestMenus('After pressing down in sortby menu', [], focusables.sortby, [focusables.packagesMenu], [focusables.toolsMenu], [
                focusables.sortbyMenu,
                focusables.stringsMenu,
                focusables.numbersMenu
            ]),
            ...
            Keyboard.sKeydown(doc, Keys.right(), {}),
            sTestMenus('After pressing right again after Escape', [], focusables.strings, [focusables.sortbyMenu], [focusables.toolsMenu, focusables.packagesMenu], [
                focusables.stringsMenu,
                focusables.numbersMenu
            ]),
            ...
            Keyboard.sKeydown(doc, Keys.down(), {}),
            Keyboard.sKeydown(doc, Keys.enter(), {}),
            sTestMenus('After pressing right again after Escape', [], focusables.doubled, [focusables.numbersMenu], [focusables.sortbyMenu, focusables.toolsMenu, focusables.packagesMenu], [
                focusables.stringsMenu
            ]),
            // Pressing enter should trigger doubled
            Keyboard.sKeydown(doc, Keys.enter(), {}),
            sTestMenus('After pressing enter on last level', ['dropdown.menu.execute: doubled'], focusables.doubled, [focusables.numbersMenu], [focusables.sortbyMenu, focusables.toolsMenu, focusables.packagesMenu], [
                focusables.stringsMenu
            ]),
            // Hover on "strings"
            Mouse.sHoverOn(gui.element(), focusables.strings.selector),
            sTestMenus('After hovering on "strings"', [], focusables.versions, [focusables.stringsMenu], [focusables.sortbyMenu, focusables.toolsMenu, focusables.packagesMenu], [
                focusables.numbersMenu
            ]),
            // Click on "about"
            ...
            sTestMenus('After hovering on "strings"', [], focusables.about, [focusables.toolsMenu], [], [
                focusables.packagesMenu,
                focusables.sortbyMenu,
                focusables.stringsMenu,
                focusables.numbersMenu
            ...
            Keyboard.sKeydown(doc, Keys.right(), {}),
            sTestMenus('Pressing <right> on "about" does nothing', [], focusables.about, [focusables.toolsMenu], [], [
                focusables.packagesMenu,
                focusables.sortbyMenu,
                focusables.stringsMenu,
                focusables.numbersMenu
            ...
            sTestMenus('After pressing <tab> from about', [], focusables.widget, [focusables.toolsMenu], [], [
                focusables.packagesMenu,
                focusables.sortbyMenu,
                focusables.stringsMenu,
                focusables.numbersMenu
            ...
            Keyboard.sKeydown(doc, Keys.enter(), {}),
            sTestMenus('After pressing <enter> on inline widget', [], focusables.widgetOne, [focusables.toolsMenu], [], [
                focusables.packagesMenu,
                focusables.sortbyMenu,
                focusables.stringsMenu,
                focusables.numbersMenu
            ...
            Keyboard.sKeydown(doc, Keys.escape(), {}),
            sTestMenus('After pressing <escape> inside inline widget', [], focusables.widget, [focusables.toolsMenu], [], [
                focusables.packagesMenu,
                focusables.sortbyMenu,
                focusables.stringsMenu,
                focusables.numbersMenu
...
//# sourceMappingURL=DropdownMenuTest.js.map