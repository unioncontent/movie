...
UnitTest.asynctest('Browser Test: events.BroadcastingEventsTest', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        ...
        return [
            ...
            Waiter.sTryUntil('Checking for scrolling message', store.sAssertEq('Should have scrolled', ['scroll']), 100, 1000),
            store.sClear,
            Step.sync(function () {
                window.scrollTo(0, 0);
            }),
            Waiter.sTryUntil('Checking for scrolling message (scrolling back to 0)', store.sAssertEq('Should have scrolled', ['scroll']), 100, 1000),
            store.sClear,
            GuiSetup.mRemoveStyles
        ];
    }, function () { success(); }, failure);
});
//# sourceMappingURL=BroadcastingEventsTest.js.map