...
UnitTest.asynctest('Basic Form', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        return GuiFactory.build(Form.sketch(function (parts) {
            return {
                dom: {
                    tag: 'div'
                },
        ...
        var sAssertDisplay = function (inputText, selectValue) {
            return Step.sync(function () {
                Assertions.assertStructure('Checking that HTML select and text input have right contents', ApproxStructure.build(function (s, str, arr) {
        ...
        return [
            Logger.t('Initial values', GeneralSteps.sequence([
                helper.sAssertRep({
                    'form.ant': 'Init',
            ...
            Logger.t('Setting "form.ant" to ant-value', GeneralSteps.sequence([
                helper.sSetRep({
                    'form.ant': 'ant-value'
                }),
                helper.sAssertRep({
            ...
            Logger.t('Setting multiple values but the select value is invalid', GeneralSteps.sequence([
                helper.sSetRep({
                    'form.ant': 'ant-value',
            ...
            Logger.t('Setting "form.ant" and "form.bull" to valid values', GeneralSteps.sequence([
                helper.sSetRep({
                    'form.ant': 'ant-value',
            ...
            Logger.t('Retrieve the bull field directly and check its value', GeneralSteps.sequence([
                Step.sync(function () {
...
//# sourceMappingURL=BasicFormTest.js.map