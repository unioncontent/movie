...
UnitTest.asynctest('Flat Grid Keying Test', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        var item = function (classes) {
            return Container.sketch({
                ...
                events: AlloyEvents.derive([
                    AlloyEvents.runOnExecute(store.adder('item.execute: ' + classes.join(',')))
                ]),
        ...
        var targets = Objects.wrapAll(Arr.map(squares, function (sq) {
            return {
                key: sq,
                value: {
                    label: sq,
        ...
        return [
            ...
            store.sAssertEq('Execute should have s21', ['item.execute: s21']),
...
//# sourceMappingURL=FlatgridKeyingTest.js.map