...
UnitTest.asynctest('TransitioningTest', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        ...
        return [
            ...
            Assertions.sAssertStructure('Checking initial state', ApproxStructure.build(function (s, str, arr) {
            ...
            Assertions.sAssertStructure('Checking transitioned state to gamma (jump)', ApproxStructure.build(function (s, str, arr) {
                return s.element('div', {
                    attrs: {
            ...
            Assertions.sAssertStructure('Checking transitioned state to beta (progress)', ApproxStructure.build(function (s, str, arr) {
                return s.element('div', {
                    attrs: {
                        'data-transitioning-state': str.is('gamma'),
            ...
            Waiter.sTryUntil('Waiting until state gets to beta', store.sAssertEq('Checking state', [
                'finish: beta',
                'gamma->beta'
            ]), 100, 3000),
            store.sClear,
            ...
            Waiter.sTryUntil('Waiting until state gets to alpha', store.sAssertEq('Checking state', [
                'finish: alpha',
                'beta->alpha'
            ]), 100, 3000)
        ];
...
//# sourceMappingURL=TransitioningTest.js.map