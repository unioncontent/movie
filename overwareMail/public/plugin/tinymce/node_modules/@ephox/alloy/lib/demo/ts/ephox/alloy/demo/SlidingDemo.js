...
export default (function () {
    ...
    HtmlDisplay.section(gui, 'This container slides its height', Container.sketch({
        components: [
            Container.sketch({
                uid: 'height-slider',
    ...
    HtmlDisplay.section(gui, 'This container slides its width', Container.sketch({
        components: [
            Container.sketch({
                uid: 'width-slider',
                containerBehaviours: Behaviour.derive([
...
//# sourceMappingURL=SlidingDemo.js.map