...
UnitTest.asynctest('InvalidatingTest', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        ...
        var sCheckValidOf = function (label, comp) {
            return Logger.t(label, Step.control(Assertions.sAssertStructure('Checking structure after marking valid', ApproxStructure.build(function (s, str, arr) {
                return s.element('input', {
                    classes: [
                        arr.not('test-invalid')
                    ]
                });
            }), comp.element()), Guard.tryUntil('valid', 100, 1000)));
        };
        var sCheckInvalidOf = function (label, comp) {
            return Logger.t(label, Step.control(Assertions.sAssertStructure('Checking structure after marking invalid', ApproxStructure.build(function (s, str, arr) {
                return s.element('input', {
                    classes: [
                        arr.has('test-invalid')
                    ]
                });
            }), comp.element()), Guard.tryUntil('invalid', 100, 100)));
        };
        ...
        return [
            ...
            Waiter.sTryUntil('A validation on load is configured, so wait for the first failure', sCheckInvalid('Should be invalid on load'), 100, 4000),
            Step.sync(function () {
...
//# sourceMappingURL=InvalidatingTest.js.map