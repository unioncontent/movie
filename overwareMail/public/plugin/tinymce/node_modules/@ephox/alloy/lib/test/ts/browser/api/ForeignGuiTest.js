...
UnitTest.asynctest('Browser Test: api.ForeignGuiTest', function () {
    ...
    Pipeline.async({}, [
        ...
        Assertions.sAssertStructure('Checking initial structure ... nothing is selected', ApproxStructure.build(function (s, str, arr) {
        ...
        Assertions.sAssertStructure('Checking structure after the first span is clicked', ApproxStructure.build(function (s, str, arr) {
            return s.element('div', {
                children: [
                    s.element('span', {
                        attrs: {
...
//# sourceMappingURL=ForeignGuiTest.js.map