...
UnitTest.asynctest('ToolbarGroupTest', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        return GuiFactory.build(ToolbarGroup.sketch({
            dom: {
                tag: 'div'
            },
            components: [
        ...
        return [
            Assertions.sAssertStructure('Checking initial toolbar groups', ApproxStructure.build(function (s, str, arr) {
...
//# sourceMappingURL=ToolbarGroupTest.js.map