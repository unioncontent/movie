...
UnitTest.asynctest('InputTest', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        return GuiFactory.build(Input.sketch({
        ...
        var testStructure = Step.sync(function () {
            Assertions.assertStructure('Checking initial structure of input', ApproxStructure.build(function (s, str, arr) {
        ...
        var testFocus = Logger.t('Testing input.focus selects text inside', GeneralSteps.sequence([
        ...
        var testRepresenting = Logger.t('Checking that representing is working', Step.sync(function () {
            ...
            Assertions.assertStructure('Checking new structure of input', ApproxStructure.build(function (s, str, arr) {
                return s.element('input', {
                    attrs: {
                        'type': str.is('input'),
                        'data-alloy-id': str.is('test-input-id'),
