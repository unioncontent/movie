...
UnitTest.asynctest('MouseDraggingTest', function () {
    ...
    GuiSetup.setup(function (store, doc, body) {
        ...
        var cEnsurePositionChanged = Chain.control(Chain.binder(function (all) {
        ...
        var cEnsurePinned = Chain.control(Chain.binder(function (all) {
            ...
            return pinned ? Result.value({}) : Result.error('Box should only have been pinned at 2 and 3 at top: 10px. Positions: ' + Json.stringify({
                1: all.box_position4,
        ...
        var cRecordPosition = Chain.fromChains([
            Chain.control(Chain.binder(function (box) {
        ...
        return [
            Chain.asStep({}, [
                NamedChain.asChain([
                    ...
                    NamedChain.direct('container', Chain.control(UiFinder.cFindIn('.test-blocker'), Guard.tryUntilNot('There should no longer be a blocker', 100, 100)), 'blocker'),
...
//# sourceMappingURL=MouseDraggingTest.js.map