    ...
    GuiSetup.setup(function (store, doc, body) {
        ...
        var sGrowingSteps = function (label) {
            return Logger.t(label, GeneralSteps.sequence([
                ...
                Assertions.sAssertStructure('Checking structure', ApproxStructure.build(function (s, str, arr) {
                ...
                Waiter.sTryUntil('Waiting for animation to stop (growing)', sIsGrowing, 100, 4000),
                Step.sync(function () {
        ...
        var sShrinkingSteps = function (label) {
            return Logger.t(label, GeneralSteps.sequence([
                ...
                Waiter.sTryUntil(label + '\nWaiting for animation to stop (shrinking)', sIsShrinking, 100, 4000),
                Step.sync(function () {
        ...
        return [
            ...
            Assertions.sAssertStructure('Checking initial structure', ApproxStructure.build(function (s, str, arr) {
                return s.element('div', {
                    classes: [
                        arr.has('test-sliding-closed')
                    ]
            ...
            Assertions.sAssertStructure('Checking structure of immediate shrink', ApproxStructure.build(function (s, str, arr) {
                return s.element('div', {
                    classes: [
                        arr.not('test-sliding-width-shrinking'),
                        arr.not('test-sliding-width-growing'),
...
//# sourceMappingURL=SlidingTest.js.map