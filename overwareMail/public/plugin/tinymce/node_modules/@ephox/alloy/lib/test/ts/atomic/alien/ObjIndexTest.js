...
UnitTest.test('ObjIndexTest', function () {
    ...
    Logger.sync('Empty test', function () {
        var actual = ObjIndex.byInnerKey({}, tuple);
        assertSortedEq('Checking grouping', {}, actual);
    });
    Logger.sync('test 1: basic object ... no overlap', function () {
    ...
    Logger.sync('test 1: basic object ... overlap', function () {
        var actual = ObjIndex.byInnerKey({
            aus: {
                population: 100
            },
...
//# sourceMappingURL=ObjIndexTest.js.map