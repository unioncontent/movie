...
UnitTest.asynctest('ExifReaderTest', function () {
    var success = arguments[arguments.length - 2];
    var failure = arguments[arguments.length - 1];
    var promises = problematiJPEGs.map(function (jpeg) {
        return urlToBlob(jpeg.path).then(JPEGMeta.extractFrom).then(function (meta) {
            if (jpeg.expect) {
...
//# sourceMappingURL=ExifReaderTest.js.map