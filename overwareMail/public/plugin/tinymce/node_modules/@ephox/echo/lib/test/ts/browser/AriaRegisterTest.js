...
UnitTest.test('AriaRegisterTest', function () {
    var checkTextButton = function (expectedElement, expectedContent, element, contentElement) {
        ...
        Assertions.assertStructure('Checking dialog button attributes', expectedElement, element);
        Assertions.assertStructure('Checking dialog button label attributes', expectedContent, contentElement);
    };
    checkTextButton(ApproxStructure.build(function (s, str, arr) {
    ...
    var checkLabelledField = function (expectedDom, field, name, labelText) {
        ...
        Assertions.assertStructure('Checking labelledField structure', expectedDom, element.element());
    };
    var pair = function (store, key, baseAssertion, buildAssertion) {
    ...
    checkLabelledField(ApproxStructure.build(function (s, str, arr) {
        var store = {};
...
//# sourceMappingURL=AriaRegisterTest.js.map