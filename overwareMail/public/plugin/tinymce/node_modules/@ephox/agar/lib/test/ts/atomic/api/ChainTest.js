...
UnitTest.asynctest('ChainTest', function () {
    ...
    var testChainEnforcesInput = StepAssertions.testStepsFail('Input Value is not a chain: raw.input', [
    ...
    return Pipeline.async({}, [
        Logger.t('[Should fail validation if the chain function does not wrap the output]\n', testInputValueFails),
        Logger.t('[Should pass validation if the chain function does wrap the output]\n', testInputValuePasses),
        ...
        Logger.t('[Chains should enforce input conditions]\n', testChainEnforcesInput),
