...
UnitTest.asynctest('AjaxTest', function () {
    ...
    var responses = [
        expectError('GET Query parameters incorrect', Ajax.get('/custom/sample/get/1?word=beta', ResponseType.json(), Credentials.none(), {})),
        expectValue('GET Query parameters correct', {
            results: { good: ['alpha'] }
        }, Ajax.get('/custom/sample/get/1?word=alpha', ResponseType.json(), Credentials.none(), {})),
        expectError('GET Query parameters incorrect because of custom header value', Ajax.get('/custom/sample/get/1?word=beta', ResponseType.json(), Credentials.none(), {
        ...
        }, Ajax.get('/custom/sample/get/1?word=beta', ResponseType.json(), Credentials.none(), {
            'X-custom-header': 'X-custom-header-value'
        })),
        expectError('POST with wrong data: ', Ajax.post('/custom/sample/post/1', ContentType.json({
            'send-data': 'wrong-number'
        }), ResponseType.json(), Credentials.none(), {})),
        expectValue('POST with correct data: ', {
            'post-output': ['Australia', 'US']
        }, Ajax.post('/custom/sample/post/1', ContentType.json({
            'send-data': '10'
        }), ResponseType.json(), Credentials.none(), {})),
        expectError('PUT with wrong data: ', Ajax.put('/custom/sample/put/1', ContentType.json({
            'send-data': '10'
        }), ResponseType.json(), Credentials.none(), {})),
        expectValue('PUT with correct data: ', {
            'put-output': ['Australia', 'US']
        }, Ajax.put('/custom/sample/put/1', ContentType.json({
            'send-data': '15'
        }), ResponseType.json(), Credentials.none(), {})),
        expectError('DELETE Query parameters incorrect', Ajax.del('/custom/sample/del/1?word=beta', ResponseType.json(), Credentials.none(), {})),
        expectValue('DELETE Query parameters correct', {
            results: { 'del-good': ['alpha'] }
        }, Ajax.del('/custom/sample/del/1?word=alpha', ResponseType.json(), Credentials.none(), {})),
        expectError('DELETE Query parameters incorrect because of custom header value', Ajax.del('/custom/sample/del/1?word=beta', ResponseType.json(), Credentials.none(), {
        ...
        }, Ajax.del('/custom/sample/del/1?word=beta', ResponseType.json(), Credentials.none(), {
