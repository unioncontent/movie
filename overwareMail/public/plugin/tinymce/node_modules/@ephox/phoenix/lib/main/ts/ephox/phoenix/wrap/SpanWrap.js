...
var point = function (universe, start, soffset, finish, foffset, exclusions) {
    ...
    var range = Spot.points(Spot.point(cursor.element(), cursor.offset()), Spot.point(cursor.element(), cursor.offset()));
    return Option.some({
...
var wrap = function (universe, start, soffset, finish, foffset, exclusions) {
    ...
    return Option.from(wrappers[wrappers.length - 1]).map(function (lastSpan) {
        ...
        var range = Spot.points(Spot.point(wrappers[0], 0), Spot.point(lastSpan, lastOffset));
        return {
...
//# sourceMappingURL=SpanWrap.js.map