    ...
    (function () {
        ...
        /* div+-p1
              ...
              +-p2
                 +-p2br
        */
        assert.eq(true, Compare.eq(div, DocumentPosition.commonAncestorContainer(div, 0, div, 0)), 'lca(div,0,div,0)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(div, 0, div, 0)) + ', expected: \'<div>...\'');
        assert.eq(true, Compare.eq(div, DocumentPosition.commonAncestorContainer(p1, 0, p2, 0)), 'lca(p1,0,p2,0)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(p1, 0, p2, 0)) + ', expected: \'<div>...\'');
        assert.eq(true, Compare.eq(div, DocumentPosition.commonAncestorContainer(div, 1, div, 2)), 'lca(div,1,div,2)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(div, 1, div, 2)) + ', expected: \'<div>...\'');
        assert.eq(true, Compare.eq(div, DocumentPosition.commonAncestorContainer(p1span1, 0, p2br, 0)), 'lca(p1span1,0,p2br,0)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(p1span1, 0, p2br, 0)) + ', expected: \'<div>...\'');
        assert.eq(true, Compare.eq(p1, DocumentPosition.commonAncestorContainer(p1text, 0, p1span2, 0)), 'lca(p1text,0,p1span2,0)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(p1text, 0, p1span2, 0)) + ', expected: \'p1\': <p>One, two...');
        assert.eq(true, Compare.eq(p1span, DocumentPosition.commonAncestorContainer(p1span1, 0, p1span2, 0)), 'lca(p1span1,0,p1span2,0)===' + Html.getOuter(DocumentPosition.commonAncestorContainer(p1span1, 0, p1span2, 0)) + ', expected: \'p1span\': <span>cat dog </span>');
    })();
});
