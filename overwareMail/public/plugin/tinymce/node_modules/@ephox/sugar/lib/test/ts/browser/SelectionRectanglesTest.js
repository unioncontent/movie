...
UnitTest.test('Browser Test: SelectionRectanglesTest', function () {
    ...
    assert.eq(true, rect1.top() < rect2.top(), 'Rect 1 should be above Rect 2. (1) was ' +
    ...
    assert.eq(true, bounds1.top() < bounds2.top(), 'Bounds 1 should be above bound 2. (1) was ' + bounds1.top() + ', and (2)' +
        ' was ' + bounds2.top());
    Remove.remove(p1);
    Remove.remove(p2);
});
