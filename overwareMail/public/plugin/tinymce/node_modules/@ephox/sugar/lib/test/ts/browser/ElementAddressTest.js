...
UnitTest.test('ElementAddressTest', function () {
    ...
    var checkNoneInParentOfSelector = function (startPath, ancestorSelector, descendantSelector) {
        ...
        if (actual.isSome())
            assert.fail('Expected none for parent: Was: ' + actual.getOrDie().index());
        else
    ...
    checkNoneInParentOfSelector([1, 1, 1, 2], 'th', 'th');
    checkInParentOfAny({
        parent: 'p#p1',
    ...
    var checkNoneInAncestorOfSelector = function (startPath, ancestorSelector, descendantSelector) {
        ...
        if (actual.isSome())
            assert.fail('Expected none for ancestor: Was: ' + actual.getOrDie().index());
        else
            assert.eq(true, actual.isNone());
    };
