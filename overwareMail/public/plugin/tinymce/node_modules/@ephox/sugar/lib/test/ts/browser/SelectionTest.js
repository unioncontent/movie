...
UnitTest.test('Browser Test: SelectionTest', function () {
    ...
    WindowSelection.deleteAt(window, Selection.exact(Hierarchy.follow(p1, [0, 0]).getOrDie('looking for text in a'), 'li'.length, Hierarchy.follow(p1, [1, 0]).getOrDie('looking for text in span'), 'wor'.length));
