...
UnitTest.test('EraseOperationsTest', function () {
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 1, column: 0 }), Option.some(deleteExpected1), '<table><tbody>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '<tr><th>A2</th><td>B2</td><td>C2</td><td>D2</td></tr>' +
        '</tbody></table>', TableOperations.eraseColumns, [
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected2), '<table><tbody>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '<tr><th>A2</th><td>B2</td><td>C2</td><td>D2</td></tr>' +
        '</tbody></table>', TableOperations.eraseColumns, [
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 1, column: 0 }), Option.some(deleteExpected3), '<table><tbody>' +
        '<tr><th>' +
        '<table><tbody>' +
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 1, column: 1 }), Option.some(deleteExpected4), '<table><tbody>' +
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected5), '<table><tbody>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '<tr><th>A2</th><td>B2</td><td>C2</td><td>D2</td></tr>' +
        '</tbody></table>', TableOperations.eraseRows, [
        { section: 0, row: 0, column: 0 }
    ], platform);
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected6), '<table><tbody>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '<tr><th>A2</th><td>B2</td><td>C2</td><td>D2</td></tr>' +
        '<tr><th>A3</th><td>B3</td><td>C3</td><td>D3</td></tr>' +
        '</tbody></table>', TableOperations.eraseRows, [
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected7), '<table><tbody>' +
        '<tr><th>' +
        '<table><tbody>' +
        '<tr><td>1A</td><td>1B</td></tr>' +
        '<tr><td>2A</td><td>2B</td></tr>' +
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected8), '<table><tbody>' +
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected9), '<table border="1">' +
        '<tbody><tr><td colspan="2">AB</td><td>C</td></tr>' +
        '<tr><td>D</td><td>E</td><td>F</td></tr>' +
        '<tr><td>G</td><td>H</td><td>I</td></tr></tbody></table>', TableOperations.eraseRows, [
        { section: 0, row: 0, column: 0 },
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 1, column: 2 }), Option.some(deleteExpected10), '<table border="1">' +
        '<tbody><tr><td>0</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td><td>6</td><td>7</td><td>8</td><td>9</td></tr>' +
        ...
        '<tr><td>80</td><td>81</td><td>82</td><td>83</td><td>84</td><td>85</td><td>86</td><td>87</td><td>88</td><td>89</td></tr>' +
        '<tr><td>90</td><td>91</td><td>92</td><td>93</td><td>94</td><td>95</td><td>96</td><td>97</td><td>98</td><td>99</td></tr></tbody>' +
        '</table>', TableOperations.eraseRows, [
        { section: 0, row: 1, column: 2 },
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 1, column: 1 }), Option.some(deleteExpected11), '<table border="1">' +
        '<tbody><tr><td>0</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td><td>6</td><td>7</td><td>8</td><td>9</td></tr>' +
        '<tr><td>10</td><td rowspan="2">11 21</td><td>12</td><td>13</td><td>14</td><td>15</td><td>16</td><td>17</td><td>18</td><td>19</td></tr>' +
        '<tr><td>20</td><td>22</td><td>23</td><td>24</td><td>25</td><td>26</td><td>27</td><td>28</td><td>29</td></tr>' +
        '<tr><td>30</td><td>31</td><td>32</td><td colspan="2" rowspan="3">33 34 43 44 53 54 </td><td>35</td><td>36</td><td>37</td><td>38</td><td>39</td></tr>' +
        ...
        '<tr><td>80</td><td>81</td><td>82</td><td>83</td><td>84</td><td>85</td><td>86</td><td>87</td><td>88</td><td>89</td></tr>' +
        '<tr><td>90</td><td>91</td><td>92</td><td>93</td><td>94</td><td>95</td><td>96</td><td>97</td><td>98</td><td>99</td></tr></tbody>' +
        '</table>', TableOperations.eraseColumns, [
        { section: 0, row: 1, column: 1 },
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 3, column: 3 }), Option.some(deleteExpected12), '<table border="1">' +
        '<tbody><tr><td>0</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td><td>6</td><td>7</td><td>8</td><td>9</td></tr>' +
        '<tr><td>10</td><td rowspan="2">11 21</td><td>12</td><td>13</td><td>14</td><td>15</td><td>16</td><td>17</td><td>18</td><td>19</td></tr>' +
        '<tr><td>20</td><td>22</td><td>23</td><td>24</td><td>25</td><td>26</td><td>27</td><td>28</td><td>29</td></tr>' +
        '<tr><td>30</td><td>31</td><td>32</td><td colspan="2" rowspan="3">33 34 43 44 53 54 </td><td>35</td><td>36</td><td>37</td><td>38</td><td>39</td></tr>' +
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 3, column: 3 }), Option.some(deleteExpected13), '<table border="1">' +
        '<tbody><tr><td>0</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td><td>6</td><td>7</td><td>8</td><td>9</td></tr>' +
        '<tr><td>10</td><td rowspan="2">11 21</td><td>12</td><td>13</td><td>14</td><td>15</td><td>16</td><td>17</td><td>18</td><td>19</td></tr>' +
        '<tr><td>20</td><td>22</td><td>23</td><td>24</td><td>25</td><td>26</td><td>27</td><td>28</td><td>29</td></tr>' +
        '<tr><td>30</td><td>31</td><td>32</td><td colspan="2" rowspan="3">33 34 43 44 53 54 </td><td>35</td><td>36</td><td>37</td><td>38</td><td>39</td></tr>' +
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 4, column: 7 }), Option.some(deleteExpected14), '<table border="1">' +
        '<tbody><tr><td>0</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td><td>6</td><td>7</td><td>8</td><td>9</td></tr>' +
        '<tr><td>10</td><td rowspan="2">11 21</td><td>12</td><td>13</td><td>14</td><td>15</td><td>16</td><td>17</td><td>18</td><td>19</td></tr>' +
        '<tr><td>20</td><td>22</td><td>23</td><td>24</td><td>25</td><td>26</td><td>27</td><td>28</td><td>29</td></tr>' +
        '<tr><td>30</td><td>31</td><td>32</td><td colspan="2" rowspan="3">33 34 43 44 53 54 </td><td>35</td><td>36</td><td>37</td><td>38</td><td>39</td></tr>' +
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 1 }), Option.some(deleteExpected15), '<table border="1"><tbody><tr><td rowspan="2">row 0 cell 0 row 1 cell 0 </td><td>row 0 cell 1</td><td rowspan="3">row 0 cell 2 row 1 cell 2 row 2 cell 2 </td></tr><tr><td>row 1 cell 1</td></tr><tr><td>row 2 cell 0</td><td>row 2 cell 1</td></tr><tr><td>row 3 cell 0</td><td>row 3 cell 1</td><td>row 3 cell 2</td></tr><tr><td>row 4 cell 0</td><td>row 4 cell 1</td><td>row 4 cell 2</td></tr></tbody></table>', TableOperations.eraseRows, [
        { section: 0, row: 0, column: 1 }
    ], platform);
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 1 }), Option.some(deleteExpected16), '<table border="1"><tbody><tr><td rowspan="2">row 0 cell 0 row 1 cell 0 </td><td>row 0 cell 1</td><td rowspan="3">row 0 cell 2 row 1 cell 2 row 2 cell 2 </td></tr><tr><td>row 1 cell 1</td></tr><tr><td>row 2 cell 0</td><td>row 2 cell 1</td></tr><tr><td>row 3 cell 0</td><td>row 3 cell 1</td><td>row 3 cell 2</td></tr><tr><td>row 4 cell 0</td><td>row 4 cell 1</td><td>row 4 cell 2</td></tr></tbody></table>', TableOperations.eraseRows, [
        { section: 0, row: 0, column: 1 },
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 1 }), Option.some(deleteExpected17), '<table border="1"><tbody><tr><td rowspan="2">row 0 cell 0 row 1 cell 0 </td><td>row 0 cell 1</td><td rowspan="3">row 0 cell 2 row 1 cell 2 row 2 cell 2 </td></tr><tr><td>row 1 cell 1</td></tr><tr><td>row 2 cell 0</td><td>row 2 cell 1</td></tr><tr><td>row 3 cell 0</td><td>row 3 cell 1</td><td>row 3 cell 2</td></tr><tr><td>row 4 cell 0</td><td>row 4 cell 1</td><td>row 4 cell 2</td></tr></tbody></table>', TableOperations.eraseColumns, [
        { section: 0, row: 0, column: 1 },
        { section: 0, row: 1, column: 0 } // Note: this one is 0 because hierarchy doesn't account for merged cells, here we are actually targeting cell 1,1 but in the dom structure is in position 0
    ], platform);
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected18), '<table border="1"><tbody><tr><td rowspan="2">row 0 cell 0 row 1 cell 0 </td><td>row 0 cell 1</td><td rowspan="3">row 0 cell 2 row 1 cell 2 row 2 cell 2 </td></tr><tr><td>row 1 cell 1</td></tr><tr><td>row 2 cell 0</td><td>row 2 cell 1</td></tr><tr><td>row 3 cell 0</td><td>row 3 cell 1</td><td>row 3 cell 2</td></tr><tr><td>row 4 cell 0</td><td>row 4 cell 1</td><td>row 4 cell 2</td></tr></tbody></table>', TableOperations.eraseColumns, [
    ...
    Assertions.checkDelete(Option.none(), Option.none(), '<table border="1"><tbody><tr><td rowspan="2">row 0 cell 0 row 1 cell 0 </td><td>row 0 cell 1</td><td rowspan="3">row 0 cell 2 row 1 cell 2 row 2 cell 2 </td></tr><tr><td>row 1 cell 1</td></tr><tr><td>row 2 cell 0</td><td>row 2 cell 1</td></tr><tr><td>row 3 cell 0</td><td>row 3 cell 1</td><td>row 3 cell 2</td></tr><tr><td>row 4 cell 0</td><td>row 4 cell 1</td><td>row 4 cell 2</td></tr></tbody></table>', TableOperations.eraseRows, [
        { section: 0, row: 0, column: 2 },
        { section: 0, row: 2, column: 1 },
        { section: 0, row: 3, column: 1 },
        { section: 0, row: 3, column: 2 },
    ...
    Assertions.checkDelete(Option.none(), Option.none(), '<table border="1"><tbody><tr><td rowspan="2">row 0 cell 0 row 1 cell 0 </td><td>row 0 cell 1</td><td rowspan="3">row 0 cell 2 row 1 cell 2 row 2 cell 2 </td></tr><tr><td>row 1 cell 1</td></tr><tr><td>row 2 cell 0</td><td>row 2 cell 1</td></tr><tr><td>row 3 cell 0</td><td>row 3 cell 1</td><td>row 3 cell 2</td></tr><tr><td>row 4 cell 0</td><td>row 4 cell 1</td><td>row 4 cell 2</td></tr></tbody></table>', TableOperations.eraseColumns, [
        { section: 0, row: 4, column: 0 },
        { section: 0, row: 4, column: 1 },
        { section: 0, row: 4, column: 2 }
    ], platform);
    var deleteExpectedContent19 = '<table><tbody>' +
        '<tr><th>A2</th><td>B2</td><td>C2</td><td>D2</td></tr>' +
        '</tbody></table>';
    var deleteExpected19 = {
        normal: deleteExpectedContent19,
        ie: deleteExpectedContent19
    };
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected19), '<table><thead>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '</thead>' +
        '<tbody>' +
        '<tr><th>A2</th><td>B2</td><td>C2</td><td>D2</td></tr>' +
    ...
    var deleteExpectedContent20 = '<table><thead>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '</thead></table>';
    var deleteExpected20 = {
        normal: deleteExpectedContent20,
        ie: deleteExpectedContent20
    };
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected20), '<table><thead>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '</thead>' +
        '<tbody>' +
        '<tr><th>A2</th><td>B2</td><td>C2</td><td>D2</td></tr>' +
    ...
    Assertions.checkDelete(Option.none(), Option.none(), '<table><thead>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '</thead>' +
        '<tbody>' +
        '<tr><th>A2</th><td>B2</td><td>C2</td><td>D2</td></tr>' +
    ...
    var deleteExpectedContent21 = '<table><thead>' +
        '<tr><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '</thead>' +
        '<tbody>' +
        '<tr><td>B2</td><td>C2</td><td>D2</td></tr>' +
        '</tbody></table>';
    var deleteExpected21 = {
        normal: deleteExpectedContent21,
        ie: deleteExpectedContent21
    };
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected21), '<table><thead>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '</thead>' +
        '<tbody>' +
        '<tr><th>A2</th><td>B2</td><td>C2</td><td>D2</td></tr>' +
    ...
    var deleteExpectedContent22 = '<table><thead>' +
        '<tr><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '</thead>' +
        '<tbody>' +
        '<tr><td>B2</td><td>C2</td><td>D2</td></tr>' +
        '</tbody></table>';
    var deleteExpected22 = {
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 1, column: 0 }), Option.some(deleteExpected23), '<table><tbody>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
    ...
    Assertions.checkDelete(Option.some({ section: 0, row: 0, column: 0 }), Option.some(deleteExpected24), '<table><tbody>' +
        '<tr><th>A1</th><td>B1</td><td>C1</td><td>D1</td></tr>' +
        '<tr><th>A2</th><td rowspan="2">B2</td><td>C2</td><td>D2</td></tr>' +
        '</tbody></table>', TableOperations.eraseRows, [
        { section: 0, row: 0, column: 0 }
...
//# sourceMappingURL=EraseOperationsTest.js.map