...
UnitTest.test('RecalculationsTest', function () {
    ...
    // 2x2 grid
    check([assertParts([{ element: 'a00', width: 20 }, { element: 'a01', width: 20 },
            { element: 'a10', width: 20 }, { element: 'a11', width: 20 }], [{ element: 'a00', height: 15 }, { element: 'a01', height: 15 },
    ...
    check([assertParts([{ element: 'a', width: 40 }], [{ element: 'a', height: 60 }])], [
        r('r0', [d('a', 2, 2)], 'tbody'),
        r('r1', [], 'tbody') // optional
    ], dimensions([20, 20, 99999], [30, 30, 999999]));
    // 2x3 grid merged into a single cell with total dimensions double the width and height
    check([assertParts([{ element: 'a', width: 40 }, { element: 'b', width: 15 }, { element: 'c', width: 15 }], [{ element: 'a', height: 60 }, { element: 'b', height: 30 }, { element: 'c', height: 30 }])], [
        r('r0', [d('a', 2, 2), d('b', 1, 1)], 'tbody'),
        r('r1', [d('c', 1, 1)], 'tbody')
    ], dimensions([20, 20, 15, 99999], [30, 30, 999999]));
    check([assertParts([{ element: 'a', width: 30 }, { element: 'b', width: 11 }, { element: 'c', width: 11 }], [{ element: 'a', height: 28 }, { element: 'b', height: 15 }, { element: 'c', height: 13 }])], [
        r('r0', [d('a', 2, 2), d('b', 1, 1)], 'tbody'),
        r('r1', [d('c', 1, 1)], 'tbody')
...
//# sourceMappingURL=RecalculationsTest.js.map