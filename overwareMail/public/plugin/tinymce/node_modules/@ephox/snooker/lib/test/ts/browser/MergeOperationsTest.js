...
UnitTest.test('MergeOperationsTest', function () {
    Assertions.checkMerge('SimpleCase - merging textnodes should move all content into the first cell separarted by BRs', 
    ...
    '<table style="border-collapse: collapse;"><tbody>' +
        ...
        '</tbody></table>', '<table border="1" style="border-collapse: collapse;"><tbody>' +
    ...
    '<table style="border-collapse: collapse;"><thead>' +
        ...
        '</tbody></table>', '<table border="1" style="border-collapse: collapse;"><thead>' +
        '<tr><td>a</td><td>b</td><td>c</td></tr>' +
        '<tr><td>d</td><td>e</td><td>f</td></tr>' +
        '</thead>' +
        '<tbody>' +
...
//# sourceMappingURL=MergeOperationsTest.js.map