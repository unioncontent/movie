...
var validate = function (value) {
    if (Strings.endsWith(value, '%'))
        return validateFor('%', form.percent, value);
    if (Strings.endsWith(value, 'px'))
        return validateFor('px', form.pixels, value);
...
var toIntegers = function (values) {
    ...
    var scan = Arr.foldr(values, function (rest, value) {
        var info = validate(value).fold(function () { return { value: value, remainder: 0 }; }, function (num) { return roundDown(num, 'px'); }, function (num) { return roundDown(num, '%'); });
...
//# sourceMappingURL=Redistribution.js.map