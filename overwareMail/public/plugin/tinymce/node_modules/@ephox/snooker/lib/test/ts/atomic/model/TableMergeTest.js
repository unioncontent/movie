...
UnitTest.test('TableMergeTest', function () {
    ...
    suite('insert at "j" a long table', start(3, 0), gridAphid, gridBee, generator, Fun.tripleEquals, {
        rowDelta: -4,
        colDelta: 2
    }, [
        [en('a', false), en('b', false), en('c', false)],
    ...
    suite('insert at "d" a wide table', start(1, 0), gridAphid, gridcicada, generator, Fun.tripleEquals, {
        rowDelta: 2,
        colDelta: -5
    }, [
    ...
    suite('Unmerging spans - Merge gridSpanB, into gridAdvancedOne, at "D" on gridAdvancedOne', start(1, 0), gridAdvancedOne, gridSpanB, generator, Fun.tripleEquals, {
        rowDelta: 4,
        colDelta: 2
    }, [
        [en('A', false), en('B', false), en('B', false), en('C', false)],
    ...
    suite('Unmerging spans - Merge gridSpanB, into gridAdvancedOne, at "M" on gridAdvancedOne', start(6, 3), gridAdvancedOne, gridSpanB, generator, Fun.tripleEquals, {
        rowDelta: -1,
        colDelta: -1
    }, [
    ...
    suite('Unmerging spans - Merge gridSpanB, into gridAdvancedOne, at bottom right "B" on gridAdvancedOne', start(1, 2), gridAdvancedOne, gridSpanB, generator, Fun.tripleEquals, {
        rowDelta: 4,
        colDelta: 0
    }, [
        [en('A', false), en('B', false), en('B', false), en('C', false)],
    ...
    suite('Unmerging spans - Merge gridBee, into gridAdvancedOne, at bottom left "F" on gridAdvancedOne', start(4, 0), gridAdvancedOne, gridBee, generator, Fun.tripleEquals, {
        rowDelta: -2,
        colDelta: 3
    }, [
        [en('A', false), en('B', false), en('B', false), en('C', false)],
    ...
    suite('Unmerging spans - Merge gridcicada, into gridAdvancedOne, at bottom left "I" on gridAdvancedOne', start(6, 0), gridAdvancedOne, gridcicada, generator, Fun.tripleEquals, {
        rowDelta: 0,
        colDelta: -4
    }, [
...
//# sourceMappingURL=TableMergeTest.js.map