...
UnitTest.test('ValueSchemaStuct Test', function () {
    ...
    var actualArray = ValueSchema.asStructOrDie('test.struct.arr', ValueSchema.arrOf(ValueSchema.anyValue()), ['a', 'b', 'c']);
    assert.eq('c', actualArray[2]);
    var actualArrayOfObj = ValueSchema.asStructOrDie('test.struct.arrof.obj', ValueSchema.arrOf(ValueSchema.objOf([
        FieldSchema.strict('a'),
...
//# sourceMappingURL=ValueSchemaStructTest.js.map