...
UnitTest.test('Atomic Test: api.TreeTest', function () {
    var schema = ValueSchema.objOf([
        ...
        FieldSchema.field('branches', 'branches', FieldPresence.defaulted([]), ValueSchema.thunkOf('recursive', function () {
    ...
    var processType = function (dsl) {
        DslType.foldType(dsl, function (validator, valueType) {
        ...
        }, function (validator) { }, function (key, branches) {
            throw new Error('Nothing is using a "choice" type here');
        }, function () { }, function (args, outputSchema) {
