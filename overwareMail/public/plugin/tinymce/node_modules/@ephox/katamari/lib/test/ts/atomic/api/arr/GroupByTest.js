...
UnitTest.test('Group By Test', function () {
    (function () {
        ...
        Jsc.property('Adjacent groups have different hashes, and everything in a group has the same hash', Jsc.array(Jsc.json), Jsc.fun(Jsc.string), function (xs, f) {
            ...
            var values = Arr.map(groups, function (group) {
                ...
                if (!isSame)
                    throw 'Not everything in a group has the same g(..) value';
                return first;
            });
        ...
        Jsc.property('Flattening groups equals the original array', Jsc.array(Jsc.json), Jsc.fun(Jsc.string), function (xs, f) {
            var groups = Arr.groupBy(xs, function (x) {
                return f(x);
            });
