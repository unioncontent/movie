...
UnitTest.test('FlattenTest', function () {
    ...
    checkError([function () { }]);
    checkError([42]);
    Jsc.property('Flatten is symmetric with chunking', Jsc.array(Jsc.json), Jsc.integer(1, 5), function (arr, chunkSize) {
