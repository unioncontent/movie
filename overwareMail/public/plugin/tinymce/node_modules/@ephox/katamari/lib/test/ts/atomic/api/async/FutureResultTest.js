    ...
    var testNu = function () {
        return new Promise(function (resolve, reject) {
            FutureResult.nu(function (callback) {
                callback(Result.value('future.nu'));
            }).get(function (res) {
                res.fold(function (err) {
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            comparison.match({
                                ...
                                bothValues: function (valInit, valBind) {
                                    ...
                                    binder(valInit).toLazy().get(function (resF) {
                                        resF.fold(function (errF) {
                                            reject('After binding the value, bindFuture should be a error: ' + errF + ', but was value: ' + valBind);
                                        }, function (valF) {
                                            return Jsc.eq(valBind, valF) ? resolve(true) : reject('Both bind results were values, but the values did not match\n' +
                                                'First: ' + valBind + '\n' +
                                                'Second: ' + valF);
                                        });
                                    });
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            comparison.match({
                                ...
                                bothValues: function (valInit, valBind) {
                                    ...
                                    return Jsc.eq(valBind, valF) ? resolve(true) : reject('Mapper results did not match\n' +
                                        'First: ' + valBind + '\n' +
                                        'Second: ' + valF);
                                }
                            });
