...
UnitTest.test('removeTrailing', function () {
    ...
    check('cat', 'cat/', '/');
    check('', 'cat/', 'cat/');
    Jsc.property('endsWith(removeTrailing(str, s1), s1) === false (unless it doubled up)', Jsc.asciistring, Jsc.asciinestring, function (str, s1) {
        ...
        return Jsc.eq(doubleEnd, Strings.endsWith(Strings.removeTrailing(str, s1), s1));
    });
    Jsc.property('removeTrailing(str + s1, s1) === str', Jsc.asciistring, Jsc.asciinestring, function (str, s1) {
