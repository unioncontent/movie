...
UnitTest.test('ResultsTest', function () {
    ...
    Jsc.property('Check that values should be empty and  errors should be all if we only generate errors', Jsc.array(arbResultError), function (resErrors) {
    ...
    Jsc.property('Check that errors should be empty and values should be all if we only generate values', Jsc.array(arbResultValue), function (resValues) {
    ...
    Jsc.property('Check that the total number of values and errors matches the input size', Jsc.array(arbResult), function (results) {
    ...
    Jsc.property('Check that two errors always equal comparison.bothErrors', arbResultError, arbResultError, function (r1, r2) {
    ...
    Jsc.property('Check that error, value always equal comparison.firstError', arbResultError, arbResultValue, function (r1, r2) {
        var comparison = Results.compare(r1, r2);
        return comparison.match({
    ...
    Jsc.property('Check that value, error always equal comparison.secondError', arbResultValue, arbResultError, function (r1, r2) {
        var comparison = Results.compare(r1, r2);
        return comparison.match({
            bothErrors: Fun.constant(false),
            firstError: Fun.constant(false),
    ...
    Jsc.property('Check that value, value always equal comparison.bothValues', arbResultValue, arbResultValue, function (r1, r2) {
        var comparison = Results.compare(r1, r2);
        return comparison.match({
            bothErrors: Fun.constant(false),
            firstError: Fun.constant(false),
