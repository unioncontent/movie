...
UnitTest.test('ArrEachTest', function () {
    ...
    Jsc.property('Each + push should equal the same array', Jsc.array(Jsc.json), function (arr) {
        var values = [];
    ...
    Jsc.property('eachr + push should equal the reverse of the array', Jsc.array(Jsc.json), function (arr) {
        var values = [];
