...
UnitTest.test('Struct.immutable', function () {
    ...
    Jsc.property('Checking struct with right number of arguments', Jsc.nearray(Jsc.string), function (rawValues) {
        // Remove duplications.
    ...
    Jsc.property('Checking struct with one fewer argument', Jsc.nearray(Jsc.string), function (rawValues) {
        // Remove duplications.
        var values = toUnique(rawValues);
        var struct = Struct.immutable.apply(undefined, values);
        try {
    ...
    Jsc.property('Checking struct with fewer arguments', Jsc.nearray(Jsc.string), Jsc.integer(1, 10), function (rawValues, numToExclude) {
        // Remove duplications.
        var values = toUnique(rawValues);
        var struct = Struct.immutable.apply(undefined, values);
        try {
    ...
    Jsc.property('Checking struct with more arguments', Jsc.nearray(Jsc.string), Jsc.nearray(Jsc.string), function (rawValues, extra) {
        // Remove duplications.
        var values = toUnique(rawValues);
        var struct = Struct.immutable.apply(undefined, values);
        try {
