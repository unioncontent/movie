      ...
      if(data.status){
        ...
        $.each(obj, function(index, value) {
          ...
          $.each(sortList, function(i, v) {
            ...
            if($('div[data-idx='+index+']').parents('.section').data('type') == '1' || $('div[data-idx='+index+']').parents('.section').data('type') == '2' || $('div[data-idx='+index+']').parents('.section').data('type') == '3' || $('div[data-idx='+index+']').parents('.section').data('type') == '5' || $('div[data-idx='+index+']').parents('.section').data('type') == 'movie'){
