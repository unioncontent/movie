      ...
      if(data.status){
        ...
        $.each(data.result.news, function(index, value) {
          ...
          if(value.news_type == "4"){
            ...
            var html = '<tr><td style="padding: 10px 0px 5px 7px;border-bottom: 1px solid #f4f4f4;"><div style="max-width: 538px;display: inline-block;text-overflow:ellipsis;white-space: initial;"><a style="text-decoration:none !important;color:black;font-weight:bold;" href="'+value.url+'" target="_blank">'+siteLogoHtml+value.media_title+replyHtml+'</a><i class="fas fa-times news-delete" data-idx="'+value.media_idx+'" data-type="news_mail" data-str="media_idx"></i></div></td><td style="padding: 10px 5px;border:1px solid #f4f4f4;border-top:0;text-align:center;color:#666;">'+value.media_name+pageHtml+'</td><td style="padding: 10px 0;border-bottom:1px solid #f4f4f4;text-align:center;color:#666;">'+value.writeDate+'</td></tr>'
